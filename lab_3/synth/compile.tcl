...
analyze -format sverilog ../rtl/multiply_add.v

elaborate multiply_add
...
write_file -format verilog -hierarchy -output ../mapped/multiply_add_mapped.v
write_file -format ddc -hierarchy -output ../mapped/multiply_add_mapped.ddc
write_sdf ../mapped/multiply_add_mapped.sdf
write_sdc ../mapped/multiply_add_mapped.sdc
